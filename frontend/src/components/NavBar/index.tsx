import Chambertran from 'assets/img/chambertran_logo.ico'

const NavBar = () => {
    return (
        <div className="d-flex flex-column flex-md-row align-items-center p-2 px-4 pb-2 mb-4 border-bottom">
        <a className="fs-4" href="http://www.chambertran.solutions" target="_blank" rel="noreferrer"> <img src={Chambertran} alt="Chambertran" width="100" /></a>
